"""
! this is more of a testing script provided by google to test if the project is connected successfully i still didn't 

! find a use case for this so i might just leave it here i case i might need 
 
? copied from this url : https://github.com/google/gmail-oauth2-tools/blob/master/python/oauth2.py
